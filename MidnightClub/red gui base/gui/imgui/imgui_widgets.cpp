...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    ImU32 check_col = ImColor(1.0f, 1.0f, 0.0f, 1.00f * text_selected->second * 6.f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    if (!(flags & ImGuiComboFlags_NoArrowButton))
    {
        ...
        RenderArrow(window->DrawList, ImVec2(value_x2 + style.FramePadding.y, frame_bb.Min.y + style.FramePadding.y + 3), ImU32(ImColor(0, 0, 0, 0)) , ImGuiDir_Down, 0.5f);
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    grab_bb.Max.y = frame_bb.Max.y;
                                                                // 188, 141, 194  // 255, 255, 0    // 1.0f, 1.0f, 0.0f, 0.05f  // 0.83f, 0.65f, 0.86f, 2.00f
    if (grab_bb.Max.x > grab_bb.Min.x) {
        //slider grab
        window->DrawList->AddRectFilled(grab_bb.Min, grab_bb.Max, ImColor(255, 255, 0) ,(g.ActiveId == id ? ImGuiCol_SliderGrabActive : ImGuiCol_SliderGrab), 0);
        // gradient
        window->DrawList->AddRectFilledMultiColor(grab_bb.Min, grab_bb.Max, GetColorU32(ImVec4(0.83f, 0.65f, 0.86f, 3.00f)), GetColorU32(ImVec4(0.83f, 0.65f, 0.86f, 3.00)), GetColorU32(ImVec4(0.83f, 0.65f, 0.86f, 3.00f)), GetColorU32(ImVec4(1.0f, 1.0f, 0.0f, 1.00f)));
         // window->DrawList->AddRectFilledMultiColor(grab_bb.Min, grab_bb.Max, GetColorU32(ImVec4(0.7f, 0.7f, 0.0f, 0.05f)), GetColorU32(ImVec4(0.83f, 0.65f, 0.86f, 3.00f)), GetColorU32(ImVec4(0.9f, 0.9f, 0.0f, 3.3f)), GetColorU32(ImVec4(0.83f, 0.65f, 0.86f, 3.00f)));
    }
...
bool ImGui::cSliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, ImColor C , const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        //slider grab
        window->DrawList->AddRectFilled(grab_bb.Min, grab_bb.Max, C, 4.f);
        // gradient
       // window->DrawList->AddRectFilledMultiColor(grab_bb.Min, grab_bb.Max, GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.05f)), GetColorU32(ImVec4(1.0f, 0.0f, 0.0f, 1.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.38f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.38f)));
        //window->DrawList->AddRectFilledMultiColor(grab_bb.Min, grab_bb.Max, GetColorU32(ImVec4(1.0f, 0.0f, 0.0f, 1.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 1.0f, 0.05f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.38f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.38f)));
    }
...
static void RenderArrowsForVerticalBar(ImDrawList* draw_list, ImVec2 pos, ImVec2 half_sz, float bar_w, float alpha)
{
    ...
    ImGui::RenderArrowPointingAt(draw_list, ImVec2(pos.x + half_sz.x + 1,         pos.y), ImVec2(half_sz.x + 2, half_sz.y + 1), ImGuiDir_Right, IM_COL32(255,0,255,alpha8));
    ImGui::RenderArrowPointingAt(draw_list, ImVec2(pos.x + half_sz.x,             pos.y), half_sz,                              ImGuiDir_Right, IM_COL32(255,255,255,alpha8));
    ImGui::RenderArrowPointingAt(draw_list, ImVec2(pos.x + bar_w - half_sz.x - 1, pos.y), ImVec2(half_sz.x + 2, half_sz.y + 1), ImGuiDir_Left,  IM_COL32(255,0,255,alpha8));
